...
export const locationFields = ['country', 'jurisdiction', 'municipality'];
export const isLocationField = (name) => locationFields.includes(name);
...
export const formatLocationLabel = ({ municipality, jurisdiction, country } = {}) =>
  [country, jurisdiction, municipality].filter(Boolean).join(', ');
